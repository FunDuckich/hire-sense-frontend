...
const mockCandidates = [
  { id: 101, name: 'Иванов Иван', status: 'Ожидает AI-интервью', resumeScore: 75, interviewScore: null, isNew: true, date: '2024-09-08' },
  { id: 102, name: 'Петрова Мария', status: 'Интервью пройдено', resumeScore: 88, interviewScore: 92, isNew: false, date: '2024-09-07' },
  { id: 103, name: 'Сидоров Алексей', status: 'Ожидает AI-интервью', resumeScore: 91, interviewScore: null, isNew: true, date: '2024-09-09' },
  { id: 105, name: 'Васильев Дмитрий', status: 'Интервью пройдено', resumeScore: 95, interviewScore: 85, isNew: false, date: '2024-09-06' },
];
